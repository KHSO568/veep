<template>
  <div class="min-h-screen bg-gray-900 text-gray-100">
    ...
    <div
      class="bg-gradient-to-r from-purple-900 via-indigo-900 to-blue-900 shadow-2xl"
    >
      <div class="max-w-7xl mx-auto px-6 py-8">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-4">
            <div
              class="w-16 h-16 bg-white rounded-2xl flex items-center justify-center shadow-xl"
            >
              <svg
            ...
            <div>
              ...
              <p class="text-indigo-200 text-sm mt-1">
                Gestion intelligente de votre catalogue
              </p>
            </div>
          </div>
    ...
    <div class="max-w-7xl mx-auto px-6 py-8">
      ...
      >
        ...
        >
          ...
          <h3 class="text-2xl font-bold mb-4 text-center text-white">
            Attention
          </h3>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1">
          <div
            class="bg-gray-800 rounded-3xl shadow-2xl overflow-hidden border-2 border-gray-700 sticky top-8"
          >
            ...
            <div class="p-6 space-y-5">
              ...
              <div>
                <label
                  class="block text-sm font-bold text-gray-300 mb-3 uppercase tracking-wide"
                  >Image</label
                >
                <button
                  type="button"
        ...
        <div class="lg:col-span-2">
          <div
            class="bg-gray-800 rounded-3xl shadow-2xl overflow-hidden border-2 border-gray-700"
          >
                  ...
                  <div class="flex gap-5">
                    ...
                    >
                      ...
                      <div
                        ...
                        v-html="p.description || 'Aucune description'"
                      ></div>
                      <div
                    ...
                    <div
                      ...
                      v-if="isAdmin || (user && p.userId === user.uid)"
                    >
                      <button
