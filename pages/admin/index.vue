  ...
  <NuxtLayout name="admin">
    <div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <StatsCard title="Utilisateurs" :value="stats.users" icon="users" color="blue" />
        <StatsCard title="Événements" :value="stats.events" icon="events" color="purple" />
        <StatsCard title="Produits" :value="stats.products" icon="products" color="green" />
        <StatsCard title="Actions (24h)" :value="stats.recentActions" icon="actions" color="orange" />
      </div>

      <!-- Quick Actions Grid -->
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <QuickActionCard to="/admin/users" title="Gestion des utilisateurs" description="Gérez les comptes et rôles"
          color="veep-orange">
          <template #icon>
        ...
        <QuickActionCard to="/profile/settings" title="Sécurité" description="2FA, sessions et mot de passe"
          color="green">
          <template #icon>
            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <QuickActionCard to="/admin/users/invitations" title="Invitations"
          description="Inviter de nouveaux utilisateurs" color="blue">
          <template #icon>
            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
