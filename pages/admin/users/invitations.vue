            ...
            <tr v-for="invitation in filteredInvitations" :key="invitation.id"
              ...
              <td class="px-6 py-4">
                <div class="flex items-center gap-3">
                  <div class="w-10 h-10 rounded-full bg-blue-500 overflow-hidden">
                    <div v-if="!invitation.avatar"
                    ...
                    <img v-else :src="invitation.avatar" class="w-full h-full object-cover" />
                  </div>
